...
for i in range(len(pb)):
    ...
    print("Sorry, you have entered and invalid query.\nPlease recheck and try again later.")
...
def thanks():
    print("**************************************************************************************************")
    print("\t\t\t Thank you for using Maxrun's Phonebook")
    print("Please visit again!")
    print("**************************************************************************************************")
    sys.exit("Goodbye, have a nice day ahead!")

print("**************************************************************************************************")
print("Hello dear user, Welcome to Maxrun's Phonebook")
print("You may now proceed to explore the wonderful world of this Phonebook!")
print("**************************************************************************************************")
